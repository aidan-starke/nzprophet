  ...
  return knex('user_crypto').del()
    .then(function () {
      ...
      return knex('user_crypto').insert([
        ...
        { id: 5, user_id: 2, crypto_id: 1, buy_price: 1.4013, investment: 196.62 },
        { id: 6, user_id: 2, crypto_id: 3, buy_price: 0.0839, investment: 670.54 },
        { id: 7, user_id: 2, crypto_id: 4, buy_price: 2487.5815, investment: 272.47 },
        { id: 8, user_id: 2, crypto_id: 6, buy_price: 0.7172, investment: 243.73 }
      ]);
    });
};
